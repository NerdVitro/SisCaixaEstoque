...
{
    public partial class FrmGerenciarProduto : FrmGerenciarCadastroBase
    {
        ...
        public override void Filtrar()
        {
            try
            {
                ...
                objGridView.Finalizar(BncSelects.BuscarProduto("WHERE PRO.DSNOMEPRODUTO LIKE '%" + TxbProduto.Text + "%'"), true);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
